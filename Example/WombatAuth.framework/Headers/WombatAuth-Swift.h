...
@interface WMAction : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull account;
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, copy) NSArray<WMAuth *> * _Nonnull auth;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull data;
- (nonnull instancetype)initWithAccount:(NSString * _Nonnull)account name:(NSString * _Nonnull)name auth:(NSArray<WMAuth *> * _Nonnull)auth data:(NSDictionary<NSString *, id> * _Nonnull)data OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface WMAction (SWIFT_EXTENSION(WombatAuth))
@end
...
typedef SWIFT_ENUM(NSInteger, WMActionType, closed) {
  WMActionTypeUnknown = 0,
  WMActionTypeAuthorize = 1,
  WMActionTypePushTransaction = 2,
  WMActionTypeSignTransaction = 3,
  WMActionTypeTransfer = 4,
};

typedef SWIFT_ENUM(NSInteger, WMResultType, closed) {
...
SWIFT_CLASS("_TtC10WombatAuth13WMTransaction")
@interface WMTransaction : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull from;
@property (nonatomic, readonly, copy) NSArray<WMAction *> * _Nonnull actions;
- (nonnull instancetype)initFrom:(NSString * _Nonnull)from actions:(NSArray<WMAction *> * _Nonnull)actions OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface WMTransaction (SWIFT_EXTENSION(WombatAuth))
@end



SWIFT_CLASS("_TtC10WombatAuth10WMTransfer")
@interface WMTransfer : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull from;
...
SWIFT_CLASS("_TtC10WombatAuth10WombatAuth")
@interface WombatAuth : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) WombatAuth * _Nonnull shared;)
+ (WombatAuth * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
/// Registers Dapp
/// \param name Dapp’s name
///
/// \param icon Dapp’s icon
///
- (void)registerAppWithName:(NSString * _Nonnull)name icon:(NSURL * _Nonnull)icon;
...
- (BOOL)openURL:(NSURL * _Nonnull)url options:(NSDictionary<UIApplicationOpenURLOptionsKey, id> * _Nonnull)options completionHandler:(SWIFT_NOESCAPE void (^ _Nonnull)(WMResultObj * _Nonnull))completion SWIFT_WARN_UNUSED_RESULT;
/// Request EOS Authorization
- (void)requestAuthorization;
/// Requests EOS Transfer
/// \param transfer Transfer details
///
- (void)requestTransfer:(WMTransfer * _Nonnull)transfer;
/// Pushes EOS Transaction
/// \param transaction Transaction details
///
- (void)pushTransaction:(WMTransaction * _Nonnull)transaction;
/// Requests EOS Signature
/// \param account Account name
///
/// \param data Signature data
///
- (void)requestSignatureWithAccount:(NSString * _Nonnull)account data:(NSString * _Nonnull)data;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
