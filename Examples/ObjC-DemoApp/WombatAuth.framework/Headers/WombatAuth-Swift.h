...
///
/// \param chainID Optional chainID. If not specified, defaults to EOS.
///
- (void)registerAppWithName:(NSString * _Nonnull)name icon:(NSURL * _Nonnull)icon chainID:(NSString * _Nullable)chainID;
